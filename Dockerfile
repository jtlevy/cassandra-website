...
# COMMAND_GENERATE_DOCS - Generate Cassandra documentation using Antora
# COMMAND_BUILD_SITE - Build site using Antora
# COMMAND_PREVIEW - Run container in preview mode where Antora is called to regenerate the site everytime content files are changed
ENV COMMAND_GENERATE_DOCS="enabled"
ENV COMMAND_BUILD_SITE="enabled"
ENV COMMAND_PREVIEW="disabled"
